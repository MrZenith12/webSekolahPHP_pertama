...
<!-- bagian jurusan -->
    <div class="container3">
        <h4>VISI</h4>
                    <p class="paragraf">
                    "Mewujudkan Lulusan SMK Negeri 2 Langsa yang Kompeten, Inovatif dan Berakhlakul Karimah." </p><br>
                    <h4>MISI</h4>
                    <p class="paragraf2">
                    Membentuk Kepribadian yang Berkarakter, Beriman, dan Bertaqwa kepada Tuhan yang Maha Esa.
                    Mengembangkan Komitmen Pendidikan "Aceh Carong" yang Islami secara Kompetitif, Berbudaya Karakter Berdasarkan Perkembangan Daerah dan Nasional.
                    Mengembangkan Jiwa Kemandirian, Kewirausahaan sebagai Pelaku Teknologi.
                    Mengembangkan dan Menerapkan Kurikulum yang sesuai Standar Nasional dan IDUKA.
                    Melakukan Mitra Kerja dengan IDUKA dan Assesor dalam Penyelenggaraan TUK Serta Pemasaran Tamatan Secara Regional dan Nasional.
                    </p>   
      </div>
