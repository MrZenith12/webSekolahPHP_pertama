...
<!-- bagian pertama -->
    <div class="container1">
      <div class="caption">
        <h2>ROHIS SMKN 2 LANGSA</h2>
        <h6>MENGEMBANGKAN AKHLAK BAGI SISWA DAN SISWI. </h6>
      </div>
    ...
    <div class="footer">
      <div class="wrapper">
            <div class="footer">
                ...
                <div class="footer-section">
                    <h3>Profil</h3>
                    <p>Sekolah Menengah Kejuruan (SMK) Negeri 2 Langsa merupakan salah satu sekolah tertua di Aceh.</p>
                </div>
                <div class="footer-section">
                    <h3>Contact</h3>
