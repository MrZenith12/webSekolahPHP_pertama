...
<!-- bagian pertama -->
    ...
    <div class="slide">
        ...
        <div class="slide2"><h2>JURUSAN SMKN 2 LANGSA</h2></div>
        <div class="slide3"><h2>JURUSAN SMKN 2 LANGSA</h2></div>
        <div class="slide4"><h2>JURUSAN SMKN 2 LANGSA</h2></div>
    </div>
...
<!-- bagian jurusan -->
    <div class="container3">
        <div class="masuk">
            <h3>1.Teknik Mesin</h3>
            <img src="image/gambar31.jpg">
        </div>

        <div class="masuk">
            <h3>2.Teknik Informatika</h3>
            <img src="image/gambar45.jpg">
        </div>

        <div class="masuk">
            <h3>3.Teknik Listrik</h3>
            <img src="image/gambar11.jpg">
        </div>

        <div class="masuk">
            <h3>4.Teknik Otomotif</h3>
            <img src="image/gambar23.jpg">
        </div>
      </div>
