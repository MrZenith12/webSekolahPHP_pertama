...
<!-- bagian jurusan -->
    <div class="container3">
        ...
        <div class="galeri">
        <div class="container">
            <h2> GALERI <br> SMKN 2 LANGSA</h2>
            <div class="boxGaleri">
                <div class="perBox">
                    <img src="image/gambar31.jpg" alt="RPL">
                    <h3>Tempat Kegiatan Praktik Mesin</h3>
                </div>

                <div class="perBox">
                    <img src="image/gambar100.jpg" alt="ATU">
                    <h3>Foto pertunjukan tarian saat PGRI</h3>
                </div>

                <div class="perBox">
                    <img src="image/gambar45.jpg" alt="APHP">
                    <h3>Tempat kegiatan praktik informatika</h3>
                </div>

                <div class="perBox">
                    <img src="image/gambar18.jpg" alt="API">
                    <h3>Lapangan SMKN 2 Langsa</h3>
                </div>
                <div class="perBox">
                    <img src="image/gambar41.jpg" alt="RPL">
                    <h3>Ruang teori 1 - 4</h3>
                </div>

                <div class="perBox">
                    <img src="image/img3.jpg" alt="ATU">
                    <h3>apel bersama kepala sekolah</h3>
                </div>

                <div class="perBox">
                    <img src="image/gambarbr.jpeg" alt="APHP">
                    <h3>Foto bersama guru</h3>
                </div>

                <div class="perBox">
                    <img src="image/gambar9.jpeg" alt="API">
                    <h3>penyelenggaraan upacara PGRI</h3>
                </div>
